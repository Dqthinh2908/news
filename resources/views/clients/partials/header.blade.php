<div class="header">
    <div class="title__top">
        <div class="container title__top-des">
            <h1 class="title__top-heading"><a class="title__top-heading-link" href="{{route('client.home')}}">Web Dân Trí</a></h1>
            ...
            <div class="header__navbar">
                <ul class="header__navbar-list">
                    <li class="header__navbar-item">
                        <a href="{{route('client.home')}}" class="header__navbar-link"><i class="fa-solid fa-house"></i></a>
                    </li>
                ...
                <ul class="header__navbar-list">
                    <li class="header__navbar-item">
                        <a href="{{route('client.modalLogin')}}" id=""  class="header__navbar-link">Đăng nhập</a>

                    </li>
                    <li class="header__navbar-item">
                        <a href="{{route('client.modalRegister')}}" id=""  class="header__navbar-link">Đăng kí</a>
                    </li>
                </ul>
            </div>
        </div>
